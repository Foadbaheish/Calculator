...
public class multiplicationTwoNumbers extends parameters{
	...
	@Test(description="Multiplication Two Numbers Functionality")
	public void addNumbers() throws MalformedURLException {
		...
		Calculat.multiplicationTwoNumbers(); // == 15
		String multiplicationTwoNumbersResult ="15";
        assertion.FormulaAssertion(multiplicationTwoNumbersResult);
